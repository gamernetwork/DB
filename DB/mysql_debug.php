 ...
 * @link       http://pear.php.net/package/DB
 */
class DB_mysql_debug extends DB_common
{
        public static $_ex_time_total = 0;
    // {{{ properties
        ...
        function querySort($a, $b)
        {
            ...
            <div class="debugger">
                    ...
                    <ul>
                            ...
                            <li class="info">
                                    <div><?php echo count($log);?> queries logged</div>
                            </li>
                            <li class="info">
                                    <div>Total query time: <?php echo $this->_total_query_time; ?></div>
                            </li>

                            <?php foreach($log as $q) { ?>
                                    <li class="log">
                                            <div <?php echo $q["time"] > 0.01 ? "class='slow'" : ""; ?>><?php echo $q["time"]; ?></div>
                                            <div><?php echo $q["query"]; ?></div>
                                            <div><?php echo number_format($q["rows"]); ?></div>
                                    </li>
                            <?php } ?>                            
                    </ul>
            </div>
            ...
            <style type="text/css">
                    ...
                    .debugger li div:nth-child(1)
                    {
                            width: 120px;
                            text-align: left;
                    }
                    
                    .debugger li div:nth-child(2)
                    {
                            width: 600px;
                        ...
                        .debugger li div:nth-child(3)
                        {
                                text-align: right;
                        }
                        
                        .debugger li div.slow
                        {
                                color: red;
                        }

                    .debugger li:first-of-type
                    {
    ...
    function simpleQuery($query)
    {
        ...
        $_bumsecs = floor( 1000000 * ( microtime( true ) - $st ) ) / 1000000;
        ...
        $this->_total_query_time += $_bumsecs;
